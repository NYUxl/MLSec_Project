...
INPUT_SHAPE = (55, 47, 3)
IMG_FILENAME_TEMPLATE = 'multi_visualize_%s_label_%d.png'
NUM_CLASSES = 1283
...
if __name__ == '__main__':
    ...
    parser.add_argument("--bd_model", type=str, default="models/multi_trigger_multi_target_bd_net.h5",
    ...
    parser.add_argument('--backdoor_data', type=str, default='data/Multi-trigger-Multi-target/sunglasses_poisoned_data.h5',
                        help="Path to validation dataset file (.h5)")
    parser.add_argument('--triggers', type=str, default='results/Multi-trigger-Multi-target',
                        help="Path to triggers directory")
