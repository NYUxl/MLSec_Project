...
MODEL_FILENAME = 'anonymous_2_bd_net.h5' # model file
RESULT_DIR = 'results/anonymous_2'  # directory for storing results
...
NUM_CLASSES = 1283  # total number of classes in the model # 1283 Youtube Face, 43 gtsrb
...
def gtsrb_visualize_label_scan_bottom_right_white_4():
    ...
    y_target_list.remove(Y_TARGET) # no need for this
