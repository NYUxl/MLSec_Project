...
RESULT_DIR = 'results/sunglasses'  # directory for storing results
IMG_FILENAME_TEMPLATE = 'sunglasses_visualize_%s_label_%d.png'  # image filename template for visualization results
